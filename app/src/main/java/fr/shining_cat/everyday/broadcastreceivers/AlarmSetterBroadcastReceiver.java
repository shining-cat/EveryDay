package fr.shining_cat.everyday.broadcastreceivers;
...
import static fr.shining_cat.everyday.broadcastreceivers.AlarmRingerBroadcastReceiver.MEDITATION_REMINDER_DISPLAY_NOTIFICATION;

public class AlarmSetterBroadcastReceiver extends BroadcastReceiver {

////////////////////////////////////////
//sets, cancel, or cancel for current day, the alarm according to preferences when user sets one AND on device reboot (all alarms are reset on device reboot)

    public final static String MEDITATION_REMINDER_SET_ALARM = "fr.shining_cat.everyday.SET_ALARM";
    public final static String MEDITATION_REMINDER_CANCEL_ALARM = "fr.shining_cat.everyday.CANCEL_ALARM";
    public final static String MEDITATION_REMINDER_CANCEL_ALARM_FOR_TODAY = "fr.shining_cat.everyday.CANCEL_ALARM_FOR_TODAY";
