...
public class RewardsEscapedListAdapter extends RecyclerView.Adapter<RewardsEscapedListAdapter.RewardViewHolder>{
    ...
    public RewardsEscapedListAdapter(Context context){
        mContext = context;
