...
////////////////////////////////////////
//Preference Dialog that will show a list of the device's ringotnes, plus a custom one (in RES/RAW) and "silent" option
//Source : https://stackoverflow.com/questions/11792120/in-preferences-select-my-sound-just-like-with-ringtonepreference/31004356#31004356
    ...
    protected void onPrepareDialogBuilder(Builder builder) {
        ...
        builder.setPositiveButton(R.string.generic_string_VALIDATE, this);
        builder.setNegativeButton(R.string.generic_string_CANCEL, this);
