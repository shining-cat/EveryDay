...
// the MeditAppliRepository callback onGetAllSessionsNotLiveComplete is handled by parent SettingsActivity, which will then actually proceed to export the data to a csv file
    ...
    protected void onDialogClosed(boolean positiveResult) {
        if(positiveResult){
            ...
            sessionRecordViewModel.getAllSessionsRecordsInBunch((MeditAppliRepository.MeditAppliRepoListener)mContext);
        }
    }
}
