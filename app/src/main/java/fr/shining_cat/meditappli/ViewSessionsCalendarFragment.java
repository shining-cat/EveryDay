 ...
 */
public class ViewSessionsCalendarFragment extends Fragment {
...
//This is the fragment used to hold a Calendar and a linked RecyclerView (with SessionsDayListAdapter as adapter) presenting each session (for selected calendar day) summary as a scrollable vertical list
    public ViewSessionsCalendarFragment() {
        // Required empty public constructor
    }

    public static ViewSessionsCalendarFragment newInstance(Long startingDateAsTime) {
        ViewSessionsCalendarFragment fragment = new ViewSessionsCalendarFragment();
...
////////////////////////////////////////
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mRootView = inflater.inflate(R.layout.fragment_view_sessions_calendar, container, false);
        //
        ...
        sessionsOfDayRecyclerView.setAdapter(mSessionsListAdapter);
